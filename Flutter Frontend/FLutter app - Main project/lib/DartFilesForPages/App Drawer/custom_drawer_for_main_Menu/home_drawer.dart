import '../MainMenuRelated(Drawer and other screens)/app_theme.dart';
...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      // ),
      DrawerList(
        index: DrawerIndex.HelperScreen,
        labelName: 'Helper Screen?',
      ...
      DrawerList(
        ...
        isAssetsImage: true,
        imageName: 'assets/App drawer assets/AppDrawer images/supportIcon.png',
      ),
      DrawerList(
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                  'assets/App drawer assets/AppDrawer images/UserPhoto.jpeg',
                              fit: BoxFit.cover,
                              ),
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                      ? Container(
                          width: 24,
                          height: 24,
                          child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.teal : AppTheme.nearlyBlack),
                        )
                      : Icon(listData.icon?.icon, color: widget.screenIndex == listData.index ? Colors.teal : AppTheme.nearlyBlack),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.teal : AppTheme.nearlyBlack,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
