...
class SeeMoreScreen extends StatefulWidget {
  ...
  final bool isRecommendation; //TODO consider this when handlling the APIs related to visited and recommended

  SeeMoreScreen({required this.hotelData, required this.isRecommendation}); // Add this constructor
